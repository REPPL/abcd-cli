...
- `.abcd/work/idea-assessments/4-jagged-frontier.md` — full assessment with 2-round review trail (chat `idea-4-jagged-frontier-r-33C475`); split static (itd-5 here) vs dynamic (Frontier Awareness) preserved in chat record.
