...
These questions were settled by the spc-5 spec — ADR-02 (`02-mcpbridge-implementation-contract.md`), ADR-01 (`01-harness-interface.md`), and the spc-5 `.6` host-reuse / failure-mapping work.
