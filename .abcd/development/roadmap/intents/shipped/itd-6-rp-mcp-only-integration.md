...
- **Failure semantics: if an MCP call to RP times out, does abcd retry, fall through to in-session, or both?**
  ...
  default 30 s with per-tool overrides. See [ADR-02 §§ 4–6](../../../research/adr/02-mcpbridge-implementation-contract.md).
