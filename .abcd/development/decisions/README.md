...
Plus a third roadmap surface — **intents** ([`../roadmap/intents/`](../intents)) — capture user-facing capability (forward-looking, press-release-shaped). Intents drive *what to build*; RFCs sharpen *whether to build it*; ADRs record *why we built it the way we did*.
