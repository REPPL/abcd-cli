...
| [adr-12](0012-issue-ledger-live-vs-structured.md) | The `.abcd/work/issues/` ledger stays the live operational ledger; structured `iss-*` store deferred until the native spec layer schedules the migration | accepted | 2026-06-06 |
