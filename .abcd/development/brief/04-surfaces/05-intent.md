...
4. Spec marked done in the native spec store   (standalone + bundle: work complete)
   ├─ native spec-store `spec close` close-hook (fn-36) → intent lifecycle reconcile (fn-28)
